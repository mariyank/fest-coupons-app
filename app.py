...
if "ticket" in st.query_params:
    ...
    if ticket_code.startswith("FEST-"):
        ...
        if not match.empty:
            ...
            <div style="display:flex; justify-content:center; align-items:center; gap:8px;"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#222" stroke-width="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg><span style="font-size:26px; font-family:'Aref Ruqaa', serif; color: #222; margin-top: -4px;">{buyer_name}</span></div>
